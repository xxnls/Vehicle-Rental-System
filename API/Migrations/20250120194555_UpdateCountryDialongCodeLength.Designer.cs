...
namespace API.Migrations
{
    ...
    [Migration("20250120194555_UpdateCountryDialongCodeLength")]
    partial class UpdateCountryDialongCodeLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.EmployeeFinance", b =>
                {
            ...
            modelBuilder.Entity("API.Models.EmployeeLeaveType", b =>
                {
                    b.Property<int>("EmployeeLeaveTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.EmployeeSchedule", b =>
                {
            ...
            modelBuilder.Entity("API.Models.Document", b =>
                {
                    b.HasOne("API.Models.Employee", "CreatedByEmployee")
                    ...
                    b.HasOne("API.Models.Employee", "ModifiedByEmployee")
                    ...
                    b.HasOne("API.Models.RentalPlace", "RentalPlace")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("API.Models.EmployeeLeave", b =>
                {
                    b.HasOne("API.Models.Employee", "ApprovedBy")
                    ...
                    b.HasOne("API.Models.EmployeeLeaveType", "EmployeeLeaveType")
            ...
            modelBuilder.Entity("API.Models.EmployeeSchedule", b =>
                {
                    ...
                    b.HasOne("API.Models.EmployeeShiftType", "EmployeeShiftType")
                    ...
                    b.HasOne("API.Models.RentalPlace", "PlaceOfWork")
                        .WithMany("EmployeeSchedules")
            ...
            modelBuilder.Entity("API.Models.PostRentalReport", b =>
                {
                    b.HasOne("API.Models.Employee", "InspectorEmployee")
            ...
            modelBuilder.Entity("API.Models.Vehicles.Vehicle", b =>
                {
                    ...
                    b.HasOne("API.Models.VehicleStatistic", "VehicleStatistics")
                        .WithMany("Vehicles")
            ...
            modelBuilder.Entity("API.Models.Customer", b =>
                {
                    ...
                    b.HasOne("API.Models.CustomerStatistic", "CustomerStatistics")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("API.Models.Employee", b =>
                {
                    ...
                    b.HasOne("API.Models.EmployeeFinance", "EmployeeFinances")
                        .WithMany("Employees")
                    ...
                    b.HasOne("API.Models.EmployeeStatistic", "EmployeeStatistics")
                        .WithMany("Employees")
