...
namespace API.Migrations
{
    ...
    [Migration("20250219060210_FrontBackLicense")]
    partial class FrontBackLicense
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.FileSystem.Document", b =>
                {
            ...
            modelBuilder.Entity("API.Models.FileSystem.DocumentCategory", b =>
                {
                    b.Property<int>("DocumentCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.FileSystem.DocumentType", b =>
                {
                    b.Property<int>("DocumentTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.Other.LicenseApprovalRequests", b =>
                {
                    b.Property<int>("LicenseApprovalRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("LicenseApprovalRequestID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LicenseApprovalRequestId"));
                    ...
                    b.Property<int?>("DocumentBackId")
                        .HasColumnType("int")
                        .HasColumnName("DocumentBackID");

                    b.Property<int?>("DocumentFrontId")
                        .HasColumnType("int")
                        .HasColumnName("DocumentFrontID");
                    ...
                    b.HasKey("LicenseApprovalRequestId")
                        .HasName("LicenseApprovalRequests_pk");

                    b.HasIndex("ApprovedByEmployeeId");

                    b.HasIndex("CustomerId");

                    b.HasIndex("DocumentBackId");

                    b.HasIndex("DocumentFrontId");

                    b.ToTable("LicenseApprovalRequests");
                });
            ...
            modelBuilder.Entity("API.Models.Rentals.Payment", b =>
                {
            ...
            modelBuilder.Entity("API.Models.Rentals.Rental", b =>
                {
                    ...
                    b.Property<string>("DamageFeePaymentStatus")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RentalStatus")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("AwaitingPickup");
            ...
            modelBuilder.Entity("API.Models.FileSystem.Document", b =>
                {
                    ...
                    b.HasOne("API.Models.FileSystem.DocumentCategory", "DocumentCategory")
                        .WithMany("Documents")
                        .HasForeignKey("DocumentCategoryId")
                        .IsRequired()
                        .HasConstraintName("Documents_DocumentCategories");

                    b.HasOne("API.Models.FileSystem.DocumentType", "DocumentType")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("API.Models.FileSystem.DocumentCategory", b =>
                {
                    b.HasOne("API.Models.FileSystem.DocumentCategory", "ParentCategory")
            ...
            modelBuilder.Entity("API.Models.News", b =>
                {
                    ...
                    b.HasOne("API.Models.FileSystem.Document", "Image")
                        .WithMany("News")
            ...
            modelBuilder.Entity("API.Models.Other.LicenseApprovalRequests", b =>
                {
                    b.HasOne("API.Models.Employees.Employee", "ApprovedByEmployee")
                        .WithMany("LicenseApprovalRequests")
                    ...
                    b.HasOne("API.Models.FileSystem.Document", "DocumentBack")
                        .WithMany()
                        .HasForeignKey("DocumentBackId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("LicenseApprovalRequests_DocumentsBack");

                    b.HasOne("API.Models.FileSystem.Document", "DocumentFront")
                        .WithMany()
                        .HasForeignKey("DocumentFrontId")
                        .OnDelete(DeleteBehavior.Restrict)
                    ...
                    b.Navigation("DocumentBack");

                    b.Navigation("DocumentFront");
                });
            ...
            modelBuilder.Entity("API.Models.Rentals.Payment", b =>
                {
                    ...
                    b.HasOne("API.Models.Rentals.Rental", "Rent")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("API.Models.Customers.Customer", b =>
                {
                    ...
                    b.Navigation("LicenseApprovalRequests");
